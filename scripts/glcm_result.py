...
def process_images_in_folder(folder_path, output_csv):
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith(".png") or filename.endswith(".jpg"):
            ...
            red_channel = img_as_ubyte(susu_area[:, :, 2])
            green_channel = img_as_ubyte(susu_area[:, :, 1])
            blue_channel = img_as_ubyte(susu_area[:, :, 0])
...
output_folder_path = 'D:/SEMESTER5/PCD/proyek_image_processing_susu/output/glcm_results'
